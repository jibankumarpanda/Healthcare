...
type NavbarButtonVariant = "primary" | "secondary" | "dark" | "gradient" | "destructive"

interface NavbarButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement | HTMLAnchorElement> {
  href?: string
